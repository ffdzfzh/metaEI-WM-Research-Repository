...
This repository accompanies the manuscript **World-Model Metasurface Embodied Intelligence (WM-metaEI)**. It organizes the released code and data used to construct semantic indoor environments, predict electromagnetic (EM) behavior, optimize information metasurface (IMS) coding patterns, operate USRP experiments, and evaluate the three demonstration scenarios.
